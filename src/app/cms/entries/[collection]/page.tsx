...
const statusStyle = {
  draft: "bg-[rgba(90,88,85,0.15)] border-[rgba(90,88,85,0.3)] text-cms-text3",
  published:
    "bg-[rgba(40,160,90,0.1)] border-[rgba(40,160,90,0.25)] text-[#50c878]",
  archived:
    "bg-[rgba(224,80,80,0.08)] border-[rgba(224,80,80,0.2)] text-cms-danger",
} as const;
        ...
        <div className="flex flex-col gap-0.5">
          ...
          {entries.map((entry) => (
            <div
              ...
              style={{ gridTemplateColumns: "1fr 100px 1fr 120px 60px" }}
            >
              <code className="font-mono text-xs text-cms-text2 overflow-hidden text-ellipsis whitespace-nowrap">
                {entry.slug}
              </code>
              ...
              <div className="flex flex-wrap gap-1 min-w-0">
                {entry.tags.length > 0 ? (
                  entry.tags.map((tag) => (
                    <span
                      key={tag.id}
                      className="font-mono text-[10px] px-1.5 py-0.5 rounded-full border border-[rgba(232,160,48,0.25)] bg-[rgba(232,160,48,0.06)] text-cms-accent"
                    >
                      {tag.name}
                    </span>
                  ))
              ...
              <div className="flex justify-end">
                <Link
                  ...
                  className="font-mono text-[11px] text-cms-accent px-2.5 py-1 rounded-cms border border-[rgba(232,160,48,0.2)] bg-[rgba(232,160,48,0.06)] hover:bg-[rgba(232,160,48,0.12)] transition-colors no-underline"
                >
                  Edit
                </Link>
              </div>
